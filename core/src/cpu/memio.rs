 ...
 */
pub(super) fn write8(s: &mut CPU, addr: u32, value: u8) {
 ...
 */
pub(super) fn write16(s: &mut CPU, addr: u32, value: u16) {
...
pub(super) fn fetch16(s: &mut CPU) -> u16 {
    ...
    let lo = (s.memory_read)(addr_lo) as u16;
    let hi = (s.memory_read)(addr_hi) as u16;
...
pub(super) fn read8(s: &CPU, addr: u32) -> u8 { (s.memory_read)(addr) }
pub(super) fn read16(s: &CPU, addr: u32) -> u16 {
